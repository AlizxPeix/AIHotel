...
//    private ImageView ivLoginWeixin, ivLoginQQ, ivLoginWeibo, ivLoginTaobao;
    ...
    private ImageView ivLoginPhoto;
...
//        ivLoginWeixin = findViewById(R.id.iv_login_weixin);
        ...
        ivLoginPhoto = findViewById(R.id.iv_login_photo);
...
//        ivLoginWeixin.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v == btnLogin) {
            ...
            OkhttpActivity Loginst = new OkhttpActivity();
            Loginst.postComment(name,passwd);
